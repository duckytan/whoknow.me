...
//   - P2 内容补强：RIDER_ASIDE 骑手环境旁白（守 R4，不回声备注），逐字对齐 §3 + §3.6
...
test('S7 契约锁：24 组合逐字对齐 §3 表格（防回归）', () => {
  ...
  const EXPECT: Array<[AddressTag, RemarkTag, string, string, string, string]> = [
    ...
    ['toilet', 'less_spicy', '公厕？？你住化粪池啊……少放辣？行，清淡点。', '（啧，公厕的单我故意慢慢做，锅都不想洗）辣子我手抖少抓了一把。', '这老板又摆烂，我急疯了狂飙……公厕我找了半天。（公厕界米其林，我来守护）', '拿好，公厕……趁热吃（别真趁热）。下次点正常地址行不行。清清淡淡，养胃。'],
    ['toilet', 'no_cilantro', '公厕？？你住化粪池啊……不要香菜？又是你。', '（啧，公厕的单我故意慢慢做，锅都不想洗）香菜我一根没放，您放心。', '这老板又摆烂，我急疯了狂飙……公厕我找了半天。（您邻居估计闻着味儿饿了）', '拿好，公厕……趁热吃（别真趁热）。下次点正常地址行不行。（确定没香菜，我检查三遍了）'],
    ['toilet', 'no_scold', '公厕是吧……行，你这地址我接了。别骂了……行，我收敛点。', '公厕这单我正常做。（被你那句「别骂了」戳中）我好好做。', '公厕这单老板居然利索，我一路畅通送到了，奇了。（化粪池今儿格外安静，稀奇）', '拿好，公厕……趁热吃（别真趁热）。你刚那句，我记下了。刚才脾气不好，见谅啊。'],
    ['toilet', 'perform', '公厕？？你住化粪池啊……表演才艺？成，今儿给你来一段。', '（啧，公厕的单我故意慢慢做，锅都不想洗）先去换身行头，您稍等，演出级出餐。', '这老板又摆烂，我急疯了狂飙……公厕我找了半天。（这片儿我送餐榜常年第一）', '拿好，公厕……趁热吃（别真趁热）。下次点正常地址行不行。谢幕鞠躬，下次点个「encore」呗。'],
    ['toilet', 'boss_thx', '公厕是吧……行，你这地址我接了。老板辛苦了？嗐，被你这么客气整不会了……', '公厕这单我正常做。（心里一暖）您这句话我记下了，多放份量。', '公厕这单老板居然利索，我一路畅通送到了，奇了。（风往这边吹，算您走运）', '拿好，公厕……趁热吃（别真趁热）。你刚那句，我记下了。（辛苦啥，您爱吃就行）'],

    // §3.2 ICU 病房 icu（warm，仅可达 warm）+ 收尾轻荒诞（守红线）
    ['icu', 'more_spicy', 'ICU 病房？我轻着点做，您安心养着。行，多放辣是吧，辣得你忘了在哪儿吃的。', '（小声）您这单我得快手快脚又轻手轻脚地做，汤别洒了。辣子现舂，等着。', 'ICU 这单我开得稳稳的，您别急，门帮您留着。（电梯今儿不排队，佛了）', '趁热趁软乎……您慢用，好好休息。（这单我比查房还上心）辣到位了，喝口水缓缓。'],
    ['icu', 'less_spicy', 'ICU 病房？我轻着点做，您安心养着。少放辣？行，清淡点。', '（小声）您这单我得快手快脚又轻手轻脚地做，汤别洒了。辣子我手抖少抓了一把。', 'ICU 这单我开得稳稳的，您别急，门帮您留着。（护士站没人拦我，溜）', '趁热趁软乎……您慢用，好好休息。（这单我比查房还上心）清清淡淡，养胃。'],
    ['icu', 'no_cilantro', 'ICU 病房？我轻着点做，您安心养着。不要香菜？又是你。', '（小声）您这单我得快手快脚又轻手轻脚地做，汤别洒了。香菜我一根没放，您放心。', 'ICU 这单我开得稳稳的，您别急，门帮您留着。（走廊闻到饭香，饿的是我）', '趁热趁软乎……您慢用，好好休息。（这单我比查房还上心）（确定没香菜，我检查三遍了）'],
    ['icu', 'no_scold', 'ICU 病房？我轻着点做，您安心养着。你倒会替我着想……那我更得好好做。', '（小声）您这单我得快手快脚又轻手轻脚地做，汤别洒了。（被你这句话暖到，手上更仔细了）我好好做。', 'ICU 这单我开得稳稳的，您别急，门帮您留着。（这层安静，我踮脚走）', '趁热趁软乎……您慢用，好好休息。（这单我比查房还上心）你这么体贴，这单我记心里了。'],
    ['icu', 'perform', 'ICU 病房？我轻着点做，您安心养着。表演才艺？成，今儿给你来一段。', '（小声）您这单我得快手快脚又轻手轻脚地做，汤别洒了。先去换身行头，您稍等，演出级出餐。', 'ICU 这单我开得稳稳的，您别急，门帮您留着。（探视时间刚过，清净）', '趁热趁软乎……您慢用，好好休息。（这单我比查房还上心）谢幕鞠躬，下次点个「encore」呗。'],
    ['icu', 'boss_thx', 'ICU 病房？我轻着点做，您安心养着。老板辛苦了？嘿，被你这么一夸，更得好好伺候了。', '（小声）您这单我得快手快脚又轻手轻脚地做，汤别洒了。（心里一暖）您这句话我记下了，多放份量。', 'ICU 这单我开得稳稳的，您别急，门帮您留着。（这单我比查房还上心）', '趁热趁软乎……您慢用，好好休息。（这单我比查房还上心）（辛苦啥，您爱吃就行）'],

    // §3.3 家庭 home（warm 温度，可达 neutral / warm）+ P2 带拆分（warm 更亲）
    ['home', 'more_spicy', '家庭单？跟回自己家一样，门都不用敲。行，多放辣是吧，辣得你忘了在哪儿吃的。', '（哼着歌）家里的味道，闭眼都拿捏得准。辣子现舂，等着。', '你家这栋我熟，溜达着就到了，门把手给您留着。（这栋电梯镜面能照出我帅）', '拿好，趁热吃，家里人惦记你呢。（碗我顺手洗了）辣到位了，喝口水缓缓。'],
    ['home', 'less_spicy', '家庭单？跟给自己家做一样，随便坐。少放辣？行，清淡点。', '（哼着歌）家的味道，火候我拿捏得准。辣子我手抖少抓了一把。', '你家这栋我熟，溜达着就到了，门把手给您留着。（邻居狗今儿没骂我）', '拿好，趁热吃——再不吃咱妈要打电话查岗了。清清淡淡，养胃。'],
    ['home', 'no_cilantro', '家庭单？跟给自己家做一样，随便坐。不要香菜？又是你。', '（哼着歌）家的味道，火候我拿捏得准。香菜我一根没放，您放心。', '你家这栋我熟，溜达着就到了，门把手给您留着。（您家香味先飘下来了）', '拿好，趁热吃——再不吃咱妈要打电话查岗了。（确定没香菜，我检查三遍了）'],
    ['home', 'no_scold', '家庭单？跟回自己家一样，门都不用敲。你倒会替我着想……那我更得好好做。', '（哼着歌）家里的味道，闭眼都拿捏得准。（被你这句话暖到，手上更仔细了）我好好做。', '你家这栋我熟，溜达着就到了，门把手给您留着。（门口拖鞋摆得真整齐）', '拿好，趁热吃，家里人惦记你呢。（碗我顺手洗了）你这么体贴，这单我记心里了。'],
    ['home', 'perform', '家庭单？跟回自己家一样，门都不用敲。表演才艺？成，今儿给你来一段。', '（哼着歌）家里的味道，闭眼都拿捏得准。先去换身行头，您稍等，演出级出餐。', '你家这栋我熟，溜达着就到了，门把手给您留着。（这层我送过最多次）', '拿好，趁热吃，家里人惦记你呢。（碗我顺手洗了）谢幕鞠躬，下次点个「encore」呗。'],
    ['home', 'boss_thx', '家庭单？跟回自己家一样，门都不用敲。老板辛苦了？嘿，被你这么一夸，更得好好伺候了。', '（哼着歌）家里的味道，闭眼都拿捏得准。（心里一暖）您这句话我记下了，多放份量。', '你家这栋我熟，溜达着就到了，门把手给您留着。（娃儿画的我肖像还在门上）', '拿好，趁热吃，家里人惦记你呢。（碗我顺手洗了）（辛苦啥，您爱吃就行）'],

    // §3.4 公司 company（cold 温度，可达 neutral / warm）+ 骑手环境旁白[0..5]
    ['company', 'more_spicy', '公司单？行，你们打工人互相折磨呗。行，多放辣是吧，辣得你忘了在哪儿吃的。', '（叹气）公司单我也就应付下，别指望多用心。辣子现舂，等着。', '公司楼我天天跑，电梯挤死，但准时给您放前台了。（电梯挤死，但我挤进来了）', '拿好，回工位趁热扒两口，别被老板抓包。辣到位了，喝口水缓缓。'],
    ['company', 'less_spicy', '公司单？行，你们打工人互相折磨呗。少放辣？行，清淡点。', '（叹气）公司单我也就应付下，别指望多用心。辣子我手抖少抓了一把。', '公司楼我天天跑，电梯挤死，但准时给您放前台了。（前台小姐姐认得我了）', '拿好，回工位趁热扒两口，别被老板抓包。清清淡淡，养胃。'],
    ['company', 'no_cilantro', '公司单？行，你们打工人互相折磨呗。不要香菜？又是你。', '（叹气）公司单我也就应付下，别指望多用心。香菜我一根没放，您放心。', '公司楼我天天跑，电梯挤死，但准时给您放前台了。（会议室灯还亮着，惨）', '拿好，回工位趁热扒两口，别被老板抓包。（确定没香菜，我检查三遍了）'],
    ['company', 'no_scold', '公司单？……得，被你这单整得我也有点想好好干。别骂了……行，我收敛点。', '公司单我也认真做，给你们打工人争口气。（被你那句「别骂了」戳中）我好好做。', '公司楼我天天跑，电梯挤死，但准时给您放前台了。（打印机比我忙）', '拿好，回工位趁热吃，今天这单我用心了。刚才脾气不好，见谅啊。'],
    ['company', 'perform', '公司单？行，你们打工人互相折磨呗。表演才艺？成，今儿给你来一段。', '（叹气）公司单我也就应付下，别指望多用心。先去换身行头，您稍等，演出级出餐。', '公司楼我天天跑，电梯挤死，但准时给您放前台了。（这层加班狗今儿挺多）', '拿好，回工位趁热扒两口，别被老板抓包。谢幕鞠躬，下次点个「encore」呗。'],
    ['company', 'boss_thx', '公司单？……得，被你这单整得我也有点想好好干。老板辛苦了？嗐，被你这么客气整不会了……', '公司单我也认真做，给你们打工人争口气。（心里一暖）您这句话我记下了，多放份量。', '公司楼我天天跑，电梯挤死，但准时给您放前台了。（饮水机空了，您自求多福）', '拿好，回工位趁热吃，今天这单我用心了。（辛苦啥，您爱吃就行）'],
  ]
